            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="background: #518e55">
                            ...
                            <a class="dropdown-item" href="objetivos.php">Objetivo</a>
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="    background: #518e55">
                            <a class="dropdown-item" href="membrosconselho.php">Membros do colegiado</a>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="gradeCurricular.php">Matriz curricular</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ProcessoSeletivo.php" >Processo seletivo</a>
                </li>
                <li class="nav-item">
